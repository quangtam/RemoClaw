...
echo -e "${BOLD}"
echo '    ____                       ______  __           '
echo '   / __ \___  ____ ___  ____  / ____/ / /___ __      __'
echo '  / /_/ / _ \/ __ `__ \/ __ \/ /     / / __ `/ | /| / /'
echo ' / _, _/  __/ / / / / / /_/ / /___  / / /_/ /| |/ |/ /'
echo '/_/ |_|\___/_/ /_/ /_/\____/\____/ /_/\__,_/ |__/|__/'
echo -e "${NC}"
echo -e "    ${CYAN}🦞 Remote control any AI coding agent 📱→💻${NC}"
echo ""
...
echo ""
echo "  ℹ️  No need to set commands via BotFather — RemoClaw registers them automatically."
echo ""
